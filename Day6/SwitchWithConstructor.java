// Switch Class with Constructor.
public class SwitchWithConstructor {	
	...
	// Constructor
	public SwitchWithConstructor(int price, int review, int current, String color, String manufacturer) {
		priceOfSwitch = price;
		customerReview = review;
		currentCapacity = current;
		colorOfSwitch = color;
		manufacturerOfSwitch = manufacturer;
	}
